...
public class MainActivity extends AppCompatActivity {
    ...
    private void callApiUserProfileList(){
        ...
        Call<List<ReponseUserListModel>> call = apiInterface.getUsersList();
            ...
            public void onResponse(Call<List<ReponseUserListModel>> call, Response<List<ReponseUserListModel>> response) {
                ...
                try {
                    if(response.body()!=null) {
                        ...
                        adapter = new ShowUserList(MainActivity.this, reponseUserListModel);
                    ...
                    e.printStackTrace();
                    Toast.makeText(MainActivity.this, "Something went wrong in response, please try again...!", Toast.LENGTH_SHORT).show();
                }
            }
